...
namespace ProductApi.Tests
{
    public  class ProductControllerTests
    {
        ...
        [Fact]
        public async Task GetAll_WhenProductsExist_ReturnOkWithProducts()
        {
            // Arrange
        ...
        [Fact]
        public async Task GetById_ExsistingId_ReturnsOkWithProrduct()
        {
            // Arrange
        ...
        public async Task Update_ValidProduct_ReturnsNoContent()
        {
            ...
            _mockRepository.UpdateAsync(product).Returns(product);
            ...
            await _mockRepository.Received(1)
                .UpdateAsync( Arg.Is<Product>(p => p.Name == "Updated Laptop"));
        }
